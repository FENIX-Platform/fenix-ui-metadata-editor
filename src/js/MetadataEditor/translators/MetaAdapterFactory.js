define([
        'jquery',
        'fx-MetaEditor/js/MetadataEditor/translators/M_Identification',
        'fx-MetaEditor/js/MetadataEditor/translators/M_Contacts',
        'fx-MetaEditor/js/MetadataEditor/translators/M_Content',
        'fx-MetaEditor/js/MetadataEditor/translators/M_Content_ReferencePopulation',
        'fx-MetaEditor/js/MetadataEditor/translators/M_Content_Coverage',
        'fx-MetaEditor/js/MetadataEditor/translators/M_InstitutionalMandate',
        'fx-MetaEditor/js/MetadataEditor/translators/M_StatisticalProcessing_PrimaryDataCollection',
        'fx-MetaEditor/js/MetadataEditor/translators/M_StatisticalProcessing_SecondaryDataCollection',
        'fx-MetaEditor/js/MetadataEditor/translators/M_StatisticalProcessing_DataCompilation',
        'fx-MetaEditor/js/MetadataEditor/translators/M_StatisticalProcessing_DataValidation',
        'fx-MetaEditor/js/MetadataEditor/translators/M_DataQuality',
        'fx-MetaEditor/js/MetadataEditor/translators/M_DataQuality_Accuracy',
        'fx-MetaEditor/js/MetadataEditor/translators/M_DataQuality_DataRevision',
        'fx-MetaEditor/js/MetadataEditor/translators/M_DataQuality_Relevance',
        'fx-MetaEditor/js/MetadataEditor/translators/M_DataQuality_ComparabilityCoherence',
        'fx-MetaEditor/js/MetadataEditor/translators/M_DataQuality_TimelinessAndPunctuality',
        'fx-MetaEditor/js/MetadataEditor/translators/M_Accessibility_Clarity',
        'fx-MetaEditor/js/MetadataEditor/translators/M_Accessibility_Confidentiality',
        'fx-MetaEditor/js/MetadataEditor/translators/M_Accessibility_DataDissemination_Distribution',
        'fx-MetaEditor/js/MetadataEditor/translators/M_Accessibility_DataDissemination_ReleasePolicy',
        'fx-MetaEditor/js/MetadataEditor/translators/M_Maintenance',
        'fx-MetaEditor/js/MetadataEditor/translators/M_Maintenance_MetadataMaintenance',
        'fx-MetaEditor/js/MetadataEditor/translators/M_Maintenance_Update'
],
function ($,
    Identification,
    Contacts,
