define({
    "schemaSource": "../submodules/fenix-ui-metadata-editor2/config/schemas/contactsSCH.json",
    "optionsSource": "../submodules/fenix-ui-metadata-editor2/config/schemas/contactsOPTS.json",
        ...
        "fields":
            {
                "typeOfCollection": {
                    "type": "select",
                    "dataSource": "../submodules/fenix-ui-metadata-editor2/config/CL/CL_FAOSTAT_Collection.json",
