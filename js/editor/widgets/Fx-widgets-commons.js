...
define([], function () {
    ...
    Fx_Commons.prototype.getFenixUniqueId = function () {
        ...
        //console.log("================== "+window.fx_dynamic_id_counter);
    ...
    Fx_Commons.prototype.commonsAddEventListener = function(evnt, elem, func) {
    ...
    // Use: commonsAddEventListener("event name", elem, func);
