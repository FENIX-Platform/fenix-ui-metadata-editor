define([
        'jquery',
        'translators/M_Identification',
        'translators/M_Contacts',
        'translators/M_Content',
        'translators/M_Content_ReferencePopulation',
        'translators/M_Content_Coverage',
        'translators/M_InstitutionalMandate',
        'translators/M_StatisticalProcessing_PrimaryDataCollection',
        'translators/M_StatisticalProcessing_SecondaryDataCollection',
        'translators/M_StatisticalProcessing_DataCompilation',
        'translators/M_StatisticalProcessing_DataValidation',
        'translators/M_DataQuality',
        'translators/M_DataQuality_Accuracy',
        'translators/M_DataQuality_DataRevision',
        'translators/M_DataQuality_Relevance',
        'translators/M_DataQuality_ComparabilityCoherence',
        'translators/M_DataQuality_TimelinessAndPunctuality',
        'translators/M_Accessibility_Clarity',
        'translators/M_Accessibility_Confidentiality',
        'translators/M_Accessibility_DataDissemination_Distribution',
        'translators/M_Accessibility_DataDissemination_ReleasePolicy',
        'translators/M_Maintenance',
        'translators/M_Maintenance_MetadataMaintenance',
        'translators/M_Maintenance_Update'
],
function ($,
    Identification,
    Contacts,
