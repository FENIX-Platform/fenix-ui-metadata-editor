define({
    "schemaSource": "./submodules/fenix-ui-metadata-editor/src/config/schemas/contactsSCH.json",
    "optionsSource": "./submodules/fenix-ui-metadata-editor/src/config/schemas/contactsOPTS.json",
        ...
        "fields":
            {
                "typeOfCollection": {
                    "type": "select",
                    "dataSource": "./submodules/fenix-ui-metadata-editor/src/config/CL/CL_FAOSTAT_Collection.json",
                ...
                "collectionPeriodicity": {                    
                    "type": "select",
                    "dataSource": "./submodules/fenix-ui-metadata-editor/src/config/CL/CL_FAO_Period.json",
