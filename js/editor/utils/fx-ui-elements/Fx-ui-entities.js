    ...
    function getEntities(select, isRequired, element, name, value, containerId, resourceType,  callback){
       ...
       // }
        ...
        select.on('change', function(){
            ...
            options.push(element_Utils.createEmptyOption(null, langProperties.pleaseSelect, lang));
            ...
            if(options.length > 1){
                var subEntitySelect = $('#'+subEntitySelectName);
                subEntitySelect.show();
                subEntitySelect.html(options.join(""));
            } else {
