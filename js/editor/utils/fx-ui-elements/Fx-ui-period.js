define([
    ...
    Fx_ui_Period.prototype.render = function (e, name, key, o, callback) {
       ...
       // }
        ...
        if(validationRule &&  bootstrapValidator_Utils){   // apply validation to start field as end date may be empty
        ...
        if(validationRule &&  bootstrapValidator_Utils){
            if(validationRule.hasOwnProperty("validators")) {
                $(containerId).on('dp.change dp.show',function (e) {
                    $('#fx-editor-form form').bootstrapValidator('revalidateField', start.attr('name'));
                });
            }
        }
