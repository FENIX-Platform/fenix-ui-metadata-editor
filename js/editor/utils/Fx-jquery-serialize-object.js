(function(jQuery) {
        ...
        raw.forEach(function(pair) {
            ...
            if(isArray(key)){
               ...
               nest(keys, value, obj);
                ...
                var $numberInput = jQuery("input[name='"+key+"']");
                var inputNumber = $numberInput.data("number");
                if(inputNumber) {
                  var inputNumberType = $numberInput.data("number-type");
                    //console.log(value + " | " + inputNumberType);
                   // console.log(parseNumberType(value, inputNumberType));
                  obj[key] = parseNumberType(value, inputNumberType);
                }
                else
                    obj[key] = value;
            }
    ...
    function parseNumberType(str, type) {
        //console.log("parseNumberType:"+ str + " | "+type);
        if(type == 'integer'){
          return parseInt(str);
        } else {
